...
Route::middleware(['checklogin'])->group(function () {
    Route::middleware(['checkrole'])->group(function(){
        ...
        Route::get('update_category/{category}', [UpdateCategoryController::class, 'showUpdateCategoryForm'])->name('update_category');
...
Route::get('list-movie-user', [ListMovieUserController::class, 'listMovieUser']);
Route::get('detail-movie-user/{movie}',[DetailMovieUserController::class, 'detailMovieUser']);
Route::middleware('checklogin')->group(function (){
    ...
    Route::get('list-movie-user-login', [ListMovieUserLoginController::class, 'listMovieUserLogin']);
    Route::get('detail-movie-user-login/{movie}',[DetailMovieUserLoginController::class, 'detailMovieUserLogin']);
});

...
<div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1 col-sm-6 col-xs-8 phl0">
                    ...
                    <div class="header_ticket">
                        <a href="" class="order_btn">My tickets</a>
                    </div>
                    <div class="header_ticket">
                    ...
                    <div class="overlay" id="overlay">
                        ...
                        <nav class="overlay-menu">
                            <ul >
                                <li><a href="{{ url('/main-login') }}" class="active">Home</a></li>
    ...
    <section class="section-content pv12 bg-cover" data-bg-image="{{asset("template/User/images/blog/bg-single.jpeg")}}">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="post-content bg-cover" data-bg-image="{{asset("template/User/images/blog/post-single.jpeg")}}">
                                ...
                                <div class="info-content">
                                    <ul class="item-info">
                                        ...
                                        <li><span>Genre:</span>  <p>@foreach($movie->categories as $category)
                                                    {{$category->name}},
                                                @endforeach</p></li>
                                ...
                                <div class="content-footer">
                                    <a href="{{ url('/book-movie-ticket/'.$movie->id) }}" class="btn order text-right"> By ticket</a>
                                </div>
                            </div>

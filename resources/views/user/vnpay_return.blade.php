...
$vnp_HashSecret =config('app.vnp_hash_secret');$secureHash = hash_hmac('sha512', $hashData, $vnp_HashSecret);
?>
<!--Begin display -->
<div class="container">
    ...
    <div class="table-responsive">
        ...
        <a type="button" class="btn btn-primary" href="{{ url('/main-login') }}">Back</a>
    </div>
    <p>

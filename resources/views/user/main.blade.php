            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1 col-sm-6 col-xs-8 phl0">
                    ...
                    <div class="header_ticket">
                        <a href="#order" class="order_btn btn_ticket">My tickets</a>
                    </div>
                                    ...
                                    <div class="movie-image" data-bg-image="{{$movie->image}}">
                                        <div class="entry-hover">
                                            <div class="entry-actions">
                                                ...
                                                <a href="{{ url('/book-movie-ticket/'.$movie->id.'') }}" class="btn-ticket order-btn ">buy ticket</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="entry-desc">
                                                <div class="row mh0">
                                                    ...
                                                    <div class="col-md-8 col-sm-7 col-xs-12 entry-text phl3">
                                                        ...
                                                        <a href="{{ url('/detail-movie-user/'.$movie->id.'') }}" class="btn more mhl20">Read more</a>
                                                    </div>
        ...
        <div class="row order-content">
            ...
            <div class="col-sm-4 col-xs-12 order_sidebar ph0">
                ...
                <div class="order-details">
                    <span> Movie:</span><p id="locationp">{{ $movie->movie_name }}</p>

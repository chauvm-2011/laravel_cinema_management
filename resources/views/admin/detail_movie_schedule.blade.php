                        ...
                        <form action="{{ url('/detail_movie_schedule/'.$movie_schedule->id.'') }}" method="post" >
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" name="start_time" value="{{ $movie_schedule->start_time }}" disabled class="form-control" placeholder="Enter start time">
                                </div>
                                <div class="form-group">
                                    <label>End time</label>
                                    <input type="time" name="end_time" value="{{ $movie_schedule->end_time }}" disabled class="form-control" placeholder="Enter end time">
                                </div>
                                <div class="form-group">
